...
namespace PdfGeneratorSample.Controllers
{
    public class HomeController : Controller
    {
        ...
        protected PdfPTable Add_Content_To_PDF(PdfPTable tableLayout)
        {
            ...
            objEmp.City = "Kochi";
            objEmp.DepartmentId = 101;
            objEmp.EmployeeId = 2001;
            objEmp.Gender = "Male";
            objEmp.Hire_Date = DateTime.Now;
            objEmp.Name = "Harshal";
        ...
        {
            tableLayout.AddCell(new PdfPCell(new Phrase(cellText, new Font(Font.FontFamily.HELVETICA, 8, 1, iTextSharp.text.BaseColor.GREEN))) { HorizontalAlignment = Element.ALIGN_LEFT, Padding = 5, BackgroundColor = new iTextSharp.text.BaseColor(255, 255, 255) });
        }
